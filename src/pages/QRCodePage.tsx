...
import { QrCode, Download, RefreshCw, ArrowLeft, Lock } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto relative">
        ...
        {!isMember && (
          <div className="absolute inset-0 z-[50] backdrop-blur-md bg-white/60 rounded-[3rem] flex flex-col items-center justify-center p-8 text-center border border-white">
            <div className="w-16 h-16 bg-amber-500 text-white rounded-2xl flex items-center justify-center mb-6 shadow-xl animate-bounce">
              <Lock size={32} />
            </div>
            <h4 className="text-slate-900 text-2xl font-black mb-4">Akses Khusus Member</h4>
            <p className="text-slate-500 mb-8 max-w-xs">
              Silakan masuk ke akun Member Anda untuk menggunakan fitur QR Code Generator.
            </p>
            <button 
